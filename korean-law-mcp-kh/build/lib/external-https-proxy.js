...
export function getExternalHttpsProxyConfig() {
...
export async function requestExternalHttps(url, options, config = getExternalHttpsProxyConfig()) {
    if (!config) {
    ...
    return new Promise((resolve, reject) => {
        ...
        agent.createConnection = (_requestOptions, callback) => {
            createProxyTlsSocket(targetUrl, config, timeout).then((socket) => callback(null, socket), (error) => callback(error));
        };
...
function createProxyTlsSocket(targetUrl, config, timeout) {
