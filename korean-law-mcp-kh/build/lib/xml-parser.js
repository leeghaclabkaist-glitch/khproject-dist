 ...
 */
export function parseSearchXML(xml, rootTag, itemTag, fieldExtractor, options) {
...
export function parsePrecedentXML(xml) {
    return parseSearchXML(xml, "PrecSearch", "prec", (content) => ({
...
export function parseInterpretationXML(xml) {
    return parseSearchXML(xml, "Expc", "expc", (content) => ({
...
export function parseAdminAppealXML(xml) {
    return parseSearchXML(xml, "Decc", "decc", (content) => ({
...
export function parseConstitutionalXML(xml) {
    // DetcSearch 루트, Detc 항목 (대문자 주의)
    return parseSearchXML(xml, "DetcSearch", "Detc", (content) => ({
...
export function parseTaxTribunalXML(xml) {
    // Decc 루트, decc 항목 (소문자)
    return parseSearchXML(xml, "Decc", "decc", (content) => ({
...
export function parseTreatyXML(xml) {
    return parseSearchXML(xml, "TrtySearch", "Trty", (content) => ({
...
export function parseCustomsXML(xml) {
    return parseSearchXML(xml, "CustomsSearch", "customs", (content) => ({
