...
export async function searchTaxTribunalDecisions(apiClient, args) {
    try {
        const extraParams = {
        ...
        if (args.dpaYd)
            extraParams.dpaYd = args.dpaYd;
        if (args.rslYd)
            extraParams.rslYd = args.rslYd;
        if (args.sort)
...
export async function getTaxTribunalDecisionText(apiClient, args) {
    try {
        const extraParams = { ID: args.id };
        if (args.decisionName)
            extraParams.LM = args.decisionName;
