 ...
 */
export async function findSimilarPrecedents(apiClient, input) {
    try {
        // 1. 입력 텍스트에서 키워드 추출
...
function rankByKeywordSimilarity(searchResultText, keywords, maxResults) {
