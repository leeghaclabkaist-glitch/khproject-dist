...
export async function searchAdminRule(apiClient, input) {
    try {
...
export async function getAdminRule(apiClient, input) {
    try {
...
export async function compareAdminRuleOldNew(apiClient, input) {
    try {
        if (input.id) {
